...
import { TESTING_CONFIG_TOKEN, TESTING_CONFIG, TestingConfig } from '@student_views/testing/testing.config';
...
@Component({
  ...
  standalone: true,
  imports: [MatFormFieldModule, MatInputModule, ReactiveFormsModule, MatRadioModule, MatButtonModule],
  providers: [
    { provide: TESTING_CONFIG_TOKEN, useValue: TESTING_CONFIG }
  ],
...
export class WritingComponent implements OnInit {
  ...
  writingThemes = signal<string[]>(['My favorite season', 'I want to be ...', 'My motherland'])
  ...
  private formInit() {
    const formGroup = <FormGroup>this.formGroup.get(Activities.WRITING);
